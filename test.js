test("converting 3.5 euros to dollars should return the correct value", function() {
    ...
    const euroAmount = 3.5; // Define the euro amount
    const expectedDollars = euroAmount * 1.07; // Calculate the expected value
    expect(fromEuroToDollar(euroAmount)).toBe(expectedDollars); // Use the expected value in the assertion
});
